...
[^21]: [21] https://zenodo.org/records/7359654 
[^22]: [22] https://www.springernature.com/gp/librarians/tools-services/implement/discovery/kbart 
[^23]: [23] https://support.datacite.org/docs/datacite-metadata-schema-44 
[^24]: [24] OAI-PMH uses XML Schemas to define record formats, but its minimum standard for interoperability is Dublin Core (oai_dc schema). 
